      ...
      >
        ...
        <aside className="panel run-summary">
          ...
          <div className="summary-note">
            Recognition uses live Google Lens matches through SerpApi. Match candidates are sent to review rather than treated as verified fitment. {workflowMode === "training" ? "Reviewed field corrections become durable operating examples." : "Production edits remain audited but do not enter training memory."}
          </div>
        </aside>
      </div>
    </div>
